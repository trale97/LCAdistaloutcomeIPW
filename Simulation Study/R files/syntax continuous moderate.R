################################################################################
#### Title: Generate syntax files for continuous Z and moderate separation condition
#### Author: Tra T. Le
...
for(b in B) {
  for(g in G) {
    for(n in N) {
      ...
      SchulerSyntax(syntaxName = paste0("Schuler_bi_B",b, "G",g, "N",n), SchulerInfile = paste0("data3biB",b, "G",g, "N",n, ".sav"), outfile = paste0("resultscontB",b, "G",g, "N",n, ".csv"))
      YamaSyntax(syntaxName = paste0("Yama_bi_B",b, "G",g, "N",n), YamaInfile = paste0("data1biB",b, "G",g, "N",n, ".sav"), outfile = paste0("resultscontB",b, "G",g, "N",n, ".csv"))
      BrayTraNaiveSyntax(syntaxName = paste0("Bray_Tra_Naive_bi_B",b, "G",g, "N",n), BrayTraNaiveInfile = paste0("data2biB",b, "G",g, "N",n, ".sav"), outfile = paste0("resultscontB",b, "G",g, "N",n, ".csv"))
    }
  }
}
